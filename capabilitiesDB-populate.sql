...
INSERT INTO `Band`(`band_name`, `band_competency`) 
    VALUES 
('Executive', 'Leadership Community');
...
INSERT INTO `Role`(`role_name`, `role_summary`, `role_training`, `role_responsibilities`, `capability_id`, `band_id`)
    ...
    ('Head Leader of Business Unit', 'Summary', 'Training', 'Responsibility', 1, 2), 
    ('Sales Executive Director', 'Summary', 'Training', 'Responsibility', 2, 1),
    ('Sales Leadership Director', 'Summary', 'Training', 'Responsibility', 2, 2);
